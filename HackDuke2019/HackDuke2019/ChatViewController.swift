...
class ChatViewController: UIViewController, UITextViewDelegate, UITableViewDataSource, UITableViewDelegate  {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .user:
            ...
            return cell
        case .botText:
            let cell = tableView.dequeueReusableCell(withIdentifier: "TextResponseTableViewCell", for: indexPath) as! UserTableViewCell //TextResponseTableViewCell
            cell.configure(with: message)
            return cell
        }
    }
...
//        NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillShow(notification:)), name: NSNotification.Name.w, object: nil)
